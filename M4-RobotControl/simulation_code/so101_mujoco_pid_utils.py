...
def build_default_pid(joint_names=DEFAULT_JOINTS) -> JointPID:
    ...
    gains = {
        "shoulder_pan":  PIDGains(kp=7.0, ki=7.0, kd=4.0, i_limit=2.0, tau_limit=8.0),
        "shoulder_lift": PIDGains(kp=6.0, ki=5.0, kd=6.0, i_limit=2.0, tau_limit=18.0),
        "elbow_flex":    PIDGains(kp=12.0, ki=6.0, kd=3.5, i_limit=2.0, tau_limit=15.0),
        "wrist_flex":    PIDGains(kp=7.0, ki=8.0, kd=3.5, i_limit=2.0, tau_limit=6.0),
        "wrist_roll":    PIDGains(kp=15.0, ki=10.0, kd=4.8, i_limit=2.0, tau_limit=3.0),
    }
